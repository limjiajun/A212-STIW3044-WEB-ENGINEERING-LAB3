...
<body style="max-width:2200px;margin:0 auto;">
  ...
  <b>Subject List</b></h2>
        ...
        <form >
            <div class="w3-row ">
                    ...
                    <p><input class="w3-input w3-block  w3-border" type="search" name="search"  
                     placeholder="Please Enter here to search the Subject List"/></p>
                </div>
    ...
    <div class="w3-center w3-bottom w3-yellow" style="max-width:3000px;margin:0 auto;">Mytutor</br>Author: LIM JIA JUN<br></div>
